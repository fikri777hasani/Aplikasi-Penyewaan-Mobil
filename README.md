# Aplikasi Penyewaan Mobil & Alat Multimedia dengan JAVA

Repository ini berisi dua versi aplikasi penyewaan:

### 1. Aplikasi Penyewaan Alat Multimedia (ArrayList)
Merupakan source code aplikasi penyewaan alat multimedia dengan metode penyimpanan menggunakan `ArrayList` (penyimpanan data sementara). Dibuat menggunakan bahasa pemrograman Java dan dijalankan di NetBeans IDE.
...
### 2. Aplikasi Penyewaan Mobil
Versi lain dari aplikasi ini berfokus pada penyewaan mobil. Detail implementasi dan fitur akan dijelaskan lebih lanjut di dokumentasi proyek.